            ...
            <div class="table-agile-info">
                <div class="panel panel-default">
                    ...
                    <div class="table-responsive">
                        ...
                        {{-- lấy dl từ session với key là message --}}
                        @if (Session('message'))
                            <span class="text-alert">{{ Session('message') }}
                                ...
                                @foreach ($all_category_product as $key => $cate_pro)
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          <a onclick="return confirm('Bạn có chắc muốn xóa danh mục này ko?')" href="{{ URL::to('/delete-category-product/'.$cate_pro->category_id) }}"  class="active
