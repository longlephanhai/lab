...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" href="./asset/fontawesome-free-6.6.0-web/fontawesome-free-6.6.0-web/css/all.min.css">
...
<body>
    <div class="app">
        <!-- Đặt tên theo chuan BEM: block__element-Modifier -->
        {{-- <header class="header">
            <div class="grid">
                    ...
                    <div class="grid__column-12">
                        <div class=" slideshow-container">
                            ...
                            <div class="mySlides fade">
                                ...
                                <img src="./asset/img/slideshow2.jpg" class="mySlides-img" style="width:100%">
                                <div class="text">Giáng sinh ấm áp</div>
                            </div>

                            <div class="mySlides fade">
                                <div class="numbertext">2 / 4</div>
                                <img src="./asset/img/slideshow3.jpg" class="mySlides-img" style="width:100%">
                                <div class="text">Tết đến đoàn viên</div>
                            </div>

                            <div class="mySlides fade">
                                <div class="numbertext">3 / 4</div>
                                <img src="./asset/img/slideshow4.jpg" class="mySlides-img" style="width:100%">
                                <div class="text">Đông ấm đại ngàn</div>
                            </div>

                            <div class="mySlides fade">
                                <div class="numbertext">4 / 4</div>
                                <img src="./asset/img/slideshow6.jpg" class="mySlides-img" style="width:100%">
                                <div class="text">Cuối hè mây trắng</div>
                            </div>
                ...
                <div class="grid__row">
                    <div class="grid__column-2-4">
                        ...
                        <ul class="footer-list">
                            ...
                            <li class="footer-item">
                                <a href="" class="footer-item__link">Shop chúng tôi</a>
                            </li>
                            <li class="footer-item">
                    ...
                    <div class="grid__column-2-4">
                        ...
                        <ul class="footer-list">
                            ...
                            <li class="footer-item">
                                <a href="" class="footer-item__link">Thủ công mỹ nghệ</a>

                            </li>
                            <li class="footer-item">
                                <a href="" class="footer-item__link">Đặc sản địa phương</a>
                        ...
                        <div class="footer__download">
                            ...
                            <div class="footer__download-apps">
                                <a href="" class="footer__download-app-link">
                                    <img src="/asset/img/ggplay.png" alt="Google Play" class="footer__download-app-img">
                                </a>
                                <a href="" class="footer__download-app-link">
                                    <img src="/asset/img/appstore.png" alt="App Store" class="footer__download-app-img">
                                </a>
